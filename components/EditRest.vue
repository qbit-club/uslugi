...
function uploadLogo(file: File) {
    ...
    imagesFormData.set(
        "logo",
        file,
        "logo_" + String(Date.now()) + "_" + String(alias.value.value) + ".jpg"
    );
    // make a preview
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="6">
                                ...
                                <v-text-field v-model="type.value.value" :error-messages="type.errorMessage.value"
                                    placeholder="кафе, магазин, доставка, ресторан" variant="outlined" density="compact"
                                    class="w-100" />
                            </v-col>
                            <v-col cols="12" md="6">
                                ...
                                <div v-if="alias.value.value.length > 0" class="label text-right">
                                    ...
                                    <i style="text-decoration: underline">{{
                                        config.public.siteUrl + "/" + alias.value.value
                                        }}</i>
                                </div>
                            </v-col>
                            <v-col cols="12" md="6">
                            ...
                            <v-col cols="12" md="6">
                                ...
                                <v-text-field v-model="socialMedia.value.value"
                                    :error-messages="socialMedia.errorMessage.value"
                                    placeholder="https://vk.com/shaurma" variant="outlined" density="compact"
                                    class="w-100" />
                            </v-col>
                            ...
                            <v-col cols="12" md="6">
                                ...
                                <div class="editor-container">
                                    <QuillEditor theme="snow" v-model:content="description" contentType="html" :toolbar="[
                            ...
                            <v-col cols="12">
                                <v-autocomplete hide-details density="compact" v-model="location"
                                    v-model:search="locationSearchRequest" :items="possibleLocations" item-title="name"
                                    placeholder="Место" item-value="geo" variant="outlined" clearable>
